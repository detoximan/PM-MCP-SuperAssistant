...
class McpClient {
  ...
  private setupMessageListeners(): void {
    ...
    contextBridge.onMessage('mcp:tool-update', message => {
      try {
        // Background broadcasts payload as { tools: [...] }, not as a raw array.
        // The old code treated that object as invalid and replaced it with [],
        // so the sidebar showed "0 of 0 tools" even though the proxy had tools.
