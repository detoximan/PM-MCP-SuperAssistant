...
import { XiaomiMiMoAdapter } from './adapters/xiaomimimo.adapter';
...
class PluginRegistry {
  ...
  private async registerBuiltInAdapters(): Promise<void> {
    ...
    // Register ZAdapter factory for z AI
      ...
      // Register XiaomiMiMoAdapter factory for Xiaomi AI Studio
      this.registerAdapterFactory({
        name: 'xiaomimimo-adapter',
        version: '1.0.0',
        type: 'website-adapter',
        hostnames: ['aistudio.xiaomimimo.com'],
        capabilities: ['text-insertion', 'form-submission'],
        create: () => new XiaomiMiMoAdapter(),
        config: {
          id: 'xiaomimimo-adapter',
          name: 'Xiaomi MiMo Adapter',
          description: 'Specialized adapter for Xiaomi AI Studio with chat input and form submission support',
          version: '1.0.0',
          enabled: true,
          priority: 5,
          settings: {
